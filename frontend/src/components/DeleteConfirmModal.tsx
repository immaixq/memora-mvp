              ...
              <div className="p-6">
                ...
                >
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      <p className="text-red-800 font-medium text-sm">This action is permanent</p>
                      <p className="text-red-600 text-sm">The memory and all associated data will be lost forever.</p>
                    </div>
                  </div>
                </motion.div>
